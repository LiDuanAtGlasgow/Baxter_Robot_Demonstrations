...
def moveit_baxter_example():
    ...
    left_target_pose.position.x = left_current_pose.position.x - 0.001  # 0.1m = 10 cm
    left_target_pose.position.z = left_current_pose.position.z - 0.001

    right_target_pose = right_current_pose
    right_target_pose.position.x = right_current_pose.position.x + 0.001
    right_target_pose.position.z = right_current_pose.position.z + 0.002
